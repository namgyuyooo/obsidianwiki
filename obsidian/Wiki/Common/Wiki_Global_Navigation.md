...
## Global Snapshot
- 생성 시각: `2026-04-29T18:32:38.320131`
- 총 페이지: `373`
- 총 링크 엣지: `1235`
- 고아 페이지: `96`
- 프로젝트/공간 수: `36`
...
## Project Coverage
- `Common`: pages `87`, memory `0`, graph links `840`
...
- `Pixel_AIVoucher_Project`: pages `11`, memory `0`, graph links `38`
- `SeoulBiosys_Project`: pages `11`, memory `0`, graph links `33`
- `HsAIVoucher_Project`: pages `10`, memory `0`, graph links `27`
- `HyundaiMobis_Project`: pages `10`, memory `0`, graph links `26`
- `KoreaAlbac_Project`: pages `10`, memory `0`, graph links `27`
- `KumhoTire_CMS_Project`: pages `10`, memory `0`, graph links `27`
- `KumhoTire_FirstProduct_Xray_Project`: pages `10`, memory `0`, graph links `30`
...
- [[Wiki/2025_20240815545_00_1723770661746_제안요청서_Project/Risks]]
