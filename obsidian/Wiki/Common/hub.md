...
## 운영 메모
- 한줄 요약: 위키 운영 모델, 자동화, 거버넌스를 실무 기준으로 관리하는 허브입니다.
...
- [[Wiki/Common/Delivery_Project_Evidence_Map]]: 계약, 발주, 납품, 검수 중심의 납품형 프로젝트 증적맵
- [[Wiki/Common/Proposal_Project_Evidence_Map]]: 제안, 견적, 요구사항, PoC 결과 중심의 제안형 프로젝트 증적맵
...
- [[Wiki/Common/Slack_Company_News/hub]]: Slack 회사 공통 소식과 공지성 대화를 모으는 허브
