...
## 실행 현황판
- 현재 상태: [[Wiki/SeoulSemicon_Project/Status]] 기준으로 현행화
- 현재 단계: [[Wiki/SeoulSemicon_Project/Status]]의 단계 기준으로 관리
- 마지막 의미 있는 갱신: 2026-04-30 구조 정비
- 현재 오너/대상: [[Wiki/SeoulSemicon_Project/Status]]의 오너 기준으로 관리
...
| --- | --- | --- | --- | --- |
| 2026-04-30 | 허브를 실무 운영형 구조로 재정비 | 상단에서 상태, 막힘, 다음 액션, 근거를 바로 확인할 수 있게 전환 | [[Wiki/SeoulSemicon_Project/Change_Log]], [[Wiki/SeoulSemicon_Project/Sources]], [[Wiki/SeoulSemicon_Project/Evidence_Log]] | 실제 진행 상황으로 현행화 |

## 상태 기준 링크
- [[Wiki/SeoulSemicon_Project/Status]]

## 증적/근거 링크
- [[Wiki/SeoulSemicon_Project/Sources]]
...
- [[Wiki/SeoulSemicon_Project/Conflict_Register]]
- [[Wiki/SeoulSemicon_Project/Change_Log]]
...
- [[Wiki/SeoulSemicon_Project/Decisions]]: 결정사항 누적
- [[Wiki/SeoulSemicon_Project/Risks]]: 리스크 및 미해결 이슈
