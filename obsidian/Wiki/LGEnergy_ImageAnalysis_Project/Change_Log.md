...
- 상태 레지스터 변경은 [[Wiki/LGEnergy_ImageAnalysis_Project/Status]]와 함께 추적합니다.
- 이 문서는 위키 구조/내용 변경 이력입니다.
- 실무 판단 자체는 [[Wiki/LGEnergy_ImageAnalysis_Project/Decisions]]에, 실행 큐는 [[Wiki/LGEnergy_ImageAnalysis_Project/Action_Items]]에 남기고 이 문서는 변경 사실을 기록합니다.
