...
## 운영 원칙
- 관련 참조는 [[Wiki/Nanotech_RnD_Project/Reference_Register]]에서 우선 확인
- 상태 레지스터 변경은 [[Wiki/Nanotech_RnD_Project/Status]]와 함께 추적합니다.
- 이 문서는 위키 구조/내용 변경 이력입니다.
- 실무 판단 자체는 [[Wiki/Nanotech_RnD_Project/Decisions]]에, 실행 큐는 [[Wiki/Nanotech_RnD_Project/Action_Items]]에 남기고 이 문서는 변경 사실을 기록합니다.
...
- 나노텍 정출연과제 공개 Slack 증적을 별도 프로젝트 문서군으로 분리
- 협업 아이템, OES 활용 고도화, 기술교류회 흐름 반영
- 정부과제 차별성 리스크 등록
