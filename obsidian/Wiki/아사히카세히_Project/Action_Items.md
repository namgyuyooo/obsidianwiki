...
## Open
- [ ] [[Wiki/아사히카세히_Project/Status]]의 상태 라벨, 단계, 헬스 갱신
- [ ] [[Wiki/아사히카세히_Project/hub]] 실행 현황판 기준으로 현재 최우선 액션 재정렬
- [ ] 담당자, 기한, 외부 확인 필요 여부를 각 액션에 보강
- [ ] [[Wiki/아사히카세히_Project/Conflict_Register]]와 [[Wiki/아사히카세히_Project/Risks]]에서 액션으로 승격할 항목 재검토
...
- 상태가 바뀌면 [[Wiki/아사히카세히_Project/Status]]도 함께 갱신합니다.
- 이 문서는 실제 실행 큐입니다. 설명형 메모보다 담당/기한/다음 행동을 우선 기록합니다.
- 승인/회의/판단 결과가 확정되면 [[Wiki/아사히카세히_Project/Decisions]] 또는 [[Wiki/아사히카세히_Project/Change_Log]]에도 함께 반영합니다.

## 기존 정리 메모
다음 액션과 확인 필요 사항을 관리합니다.
