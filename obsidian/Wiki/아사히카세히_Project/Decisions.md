...
- 현재 프로젝트의 최신 결정은 [[Wiki/아사히카세히_Project/hub]]와 [[Wiki/아사히카세히_Project/Action_Items]] 흐름과 함께 봅니다.

## 확인 대기 결정
- [[Wiki/아사히카세히_Project/Conflict_Register]] 또는 고객 확인이 필요한 판단은 확정 전까지 여기나 `Conflict_Register.md`에서 분리 관리합니다.

## 운영 메모
- 결정 이후 상태 라벨/단계가 바뀌면 [[Wiki/아사히카세히_Project/Status]]를 함께 갱신합니다.
- 새로운 결정이 생기면 [[Wiki/아사히카세히_Project/Action_Items]]의 항목 상태와 [[Wiki/아사히카세히_Project/Risks]]의 영향도 함께 갱신합니다.
- 구조 변경 자체는 [[Wiki/아사히카세히_Project/Change_Log]]에 남기고, 실무 판단은 이 문서에 남깁니다.
