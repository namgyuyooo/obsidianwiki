...
## 기존 정리 메모
## 2026-04-21
- 최근 2년 공개 Slack 기준 PSK 증적 문서군 최초 생성
- 2024 세금계산서, 방문 내역, 2025 계약 인상 준비, 2026 계약/공수/Precia/PE Agent 증적 추가
- EHM 견적/발주/납기 및 버전 명시 리스크 반영
- PE Agent 데모 운영 방식과 서버 예산/사양 수치 반영
- Precia Sobel 배포 및 threshold 리스크 반영
