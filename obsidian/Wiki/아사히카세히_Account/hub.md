...
- 승격 프로젝트: [[Wiki/아사히카세히_Project/hub]]
...
## 운영 메모
- 한줄 요약: 아사히카세히 Account Hub의 실제 업무 진행상황을 한눈에 보기 위한 허브입니다.
...
| --- | --- | --- | --- | --- |
| 2026-04-30 | 아사히카세히 Account Hub 진행상황 확인 필요 | 현재 허브는 실제 업무 추진내용을 적는 공간이며, 최신 고객/프로젝트 상태를 메모로 보강해야 함 | 연결된 Sources/Evidence_Log/원문 근거 | 담당자, 고객 대응, 산출물, 리스크, 다음 액션 업데이트 |

## 증적/근거 링크
- 연결된 Raw_Evidence_Index, Sources, Evidence_Log, 원문 근거를 우선 확인

## 운영형 문서 링크
- [[Wiki/아사히카세히_Account/Status]]: 현재 상태, 단계, 막힘, 다음 게이트
- [[Wiki/아사히카세히_Account/Business_Flow]]: 수집부터 고객 후속까지 실제 업무 흐름
- [[Wiki/아사히카세히_Account/CEO_Brief]]: CEO 의사결정 포인트
- [[Wiki/아사히카세히_Account/PM_Action_Plan]]: PM 실행 액션과 담당/기한
- [[Wiki/아사히카세히_Account/Customer_Followup]]: 고객 접점과 다음 커뮤니케이션
- [[Wiki/아사히카세히_Account/Raw_Evidence_Index]]: 원문/긴 추출문/표/수치/버전 보존

## 운영 링크
- [[Wiki/아사히카세히_Account/Project_Relationships]]
