...
class RuntimeConfig:
    ...
    def from_env_file(cls, path: Path) -> "RuntimeConfig":
        ...
        return cls(
            ...
            slack_filter_export_root=_resolve_config_path(base, payload.get("SLACK_FILTER_EXPORT_ROOT") or "obsidian/raw/exports/slack_filtered"),
            ...
            slack_project_wiki_root=_resolve_config_path(base, payload.get("SLACK_PROJECT_WIKI_ROOT") or "obsidian/Wiki/Common/Slack_Project_Intake"),
            slack_company_wiki_root=_resolve_config_path(base, payload.get("SLACK_COMPANY_WIKI_ROOT") or "obsidian/Wiki/Common/Slack_Company_News"),
